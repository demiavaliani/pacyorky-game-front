...
export default new MLCreate({
    ...
    languages: [
        new MLanguage('Ukrainian').create({
            ...
            orange_room: "Оранжевая комната",
            yellow_room: "Желтая комната",
            green_room: "Зеленая комната",
            blue_room: "Cиняя комната",
            purple_room: "Фиолетовая комната",
            golden_room: "Золотая комната",
            brown_room: "Kоричневая комната",
            black_room: "Черная комната",
            white_room: "Белая комната",
        })
    ]
})